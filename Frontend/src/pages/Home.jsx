  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end pr-6">
        <button
          onClick={toggleTheme}
          className="flex items-center gap-2 bg-blue-500 text-white px-4 py-2 rounded-full shadow hover:bg-blue-700 transition"
        >
      ...
      {darkMode && (
        <>
          <div className="absolute top-0 left-0 w-72 h-72 bg-blue-500/20 rounded-full blur-3xl animate-pulse z-0"></div>

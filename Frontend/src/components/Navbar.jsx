...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-40 px-6 py-4 backdrop-blur-md bg-gradient-to-r from-blue-800/60 via-gray-900/40 to-purple-800/50 shadow-lg border-b border-blue-500/30">

...
const Footer = () => {
  ...
  return (
    <footer className="w-full relative z-53 px-4 pt-12 pb-8">
      ...
      >
        {/* Glow Effects */}
        <div className="absolute -top-10 -left-10 w-48 h-50 bg-cyan-500/ rounded-full blur-3xl opacity-30" />
        ...
        {/* Social Links */}
        <div className="flex justify-center gap-8 sm:gap-13 mb-6 relative z-10">
          {[
            {
              icon: <FaGithub />,
              label: "GitHub",
